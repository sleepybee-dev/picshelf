...
import com.gmail.sleepybee410.picshelf.PicShelfAppWidgetConfigureActivity
...
class PicShelfAppWidgetConfigureActivity : Activity() {
    ...
    var mOnClickListener = View.OnClickListener {
        val context: Context = this@PicShelfAppWidgetConfigureActivity
    ...
    public override fun onCreate(icicle: Bundle) {
        ...
        mAppWidgetText!!.setText(
            loadTitlePref(
                this@PicShelfAppWidgetConfigureActivity,
                mAppWidgetId
            )
        )
    }
